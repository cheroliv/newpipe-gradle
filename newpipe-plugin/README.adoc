...
<p align="right">
  <a href="README_fr.adoc">
    <img src="images/lang-fr-red.svg" alt="Français" width="32"/>
  </a>
</p>
++++
...
└── newpipe/
    └── src/
        ...
        │   ├── Mp3Converter.kt          Real implementation (FFmpeg + jaudiotagger)
...
* [ ] FFmpeg via Docker support (zero system dependency)
* [ ] Configure the Docker image via the DSL (`ffmpegDockerImage`)
